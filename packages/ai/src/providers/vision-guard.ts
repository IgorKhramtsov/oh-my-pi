 ...
 * multimodal SKU (`deepseek-ocr`, `deepseek-vl`/`deepseek-vl2`,
 * `deepseek-v4-flash-vision-exp`). Matched as whole tokens so text-only SKUs
 * (`deepseek-chat`, `deepseek-reasoner`, `deepseek-v4-flash`) never match.
 */
const DEEPSEEK_VISION_MARKER = /\b(?:ocr|vision|vl\d*)\b/;
